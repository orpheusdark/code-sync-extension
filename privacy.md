...
- GitHub username and profile information required for authentication.
- The source code of accepted LeetCode submissions.
- Problem details such as title, problem number, programming language, and URL.
- User preferences including the selected GitHub repository, branch, and extension settings.

CodeSync does **not** collect passwords or GitHub credentials.
...
- Synchronize accepted LeetCode solutions to the GitHub repository you select.
- Remember your extension settings and preferences.
- Improve the reliability of the synchronization process.
...
- **GitHub**, to authenticate your account and create commits in your selected repository.
- **The CodeSync authentication backend**, when required to complete the GitHub OAuth authentication flow.

No information is shared for advertising or analytics purposes.
...
Reasonable measures are taken to protect authentication tokens and user preferences.
...
- Change the selected repository or branch at any time.
- Remove stored extension data by clearing the browser's extension storage.
